...
[Create a free account](https://bugtags.io/) and invite your team to improve your apps.
...
buildscript {
    ...
    dependencies {
        ...
        classpath 'io.bugtags.library:bugtags-gradle:latest.integration'
    }
}
allprojects {
    repositories {
...
buildscript {
    ...
    dependencies {
        classpath 'com.android.tools.build:gradle:2.1.0'
        classpath 'io.bugtags.library-canary:bugtags-gradle:latest.integration'//modify
    }
}
allprojects {
    repositories {
...
dependencies {
      compile 'io.bugtags.library-canary:bugtags-lib:latest.integration'//modify
}
```
...
- Enhancement: Optimize initialization process, add start option `startAsync` and `startCallback`, please refer: [API Reference](https://docs.bugtags.io/api/android/index.html).
